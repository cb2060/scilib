...
--
(2) Solve exercise 3 ('print text in 70 characters') of "Filehandling" using pandas and Series: put every paragraph in a different Series, combine the two lists of values in a string and print then the text, while taking care of the 70 characters - and the line break in between the two paragraphs. [A]
